    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-rose-200 selection:text-rose-900">
      ...
      <header className="sticky top-0 z-50 glass-panel border-b border-white/40 bg-white/70 backdrop-blur-md">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-serif font-bold tracking-tight text-slate-900">FashionMate<span className="text-rose-500">.</span></h1>
          </div>
      ...
      <footer className="bg-white border-t border-slate-100 py-12 mt-20">
        <div className="max-w-6xl mx-auto px-6 text-center text-slate-400">
          <p className="font-serif text-lg text-slate-900 mb-2">FashionMate.</p>
...
const ProductCard = ({ product, category }: { product: Product | undefined, category: string }) => {
  if (!product) {
    return (
      <div className="h-full min-h-[150px] bg-slate-50 rounded-xl border-2 border-dashed border-slate-200 flex items-center justify-center text-slate-400 flex-col gap-2 p-6 text-center">
  ...
  return (
    <div className="group bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-100 flex flex-col h-full">
      <div className="p-6 flex flex-col flex-grow">
        <div className="text-xs font-bold text-rose-500 uppercase tracking-wide mb-2">
          {category}
        </div>
        <div className="text-xs font-medium text-slate-500 mb-1">
          {product.ProductBrand}
        </div>
        <h3 className="font-serif text-lg leading-snug text-slate-900 mb-3">
          {product.ProductName}
        </h3>
        ...
        <div className="mt-auto flex items-center justify-between pt-4 border-t border-slate-50">
          <div className="flex items-center gap-2">
             <span className="w-3 h-3 rounded-full border border-slate-200" style={{ backgroundColor: product.PrimaryColor }}></span>
